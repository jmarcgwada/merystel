...
export function DataManagementProvider({ children }: { children: React.ReactNode }) {
  ...
  const value: PosContextType = {
      ...
      seedInitialData, deleteAllData, exportConfiguration, importConfiguration, importDemoData, importDemoCustomers, importDemoSuppliers,
