  ...
  const seedInitialData = useCallback(async () => {
    ...
    try {
      ...
      const seedItems = [
        ...
        { name: 'Jus de Pomme Artisanal 1L', price: 3.80, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'JUS-POM-1L' },
        { name: 'Limonade Bio 33cl', price: 2.90, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'LIMO-BIO-33CL' },
        { name: 'Eau Minérale Gazeuse 50cl', price: 1.50, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: '3700123456826' },
        { name: 'Coca-Cola 33cl', price: 2.50, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'COCA-33' },
        { name: 'Ice Tea Pêche 33cl', price: 2.80, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'ICETEA-PECHE' },
        { name: 'Jus d\'Ananas 25cl', price: 3.20, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'JUS-ANANAS' },
        { name: 'Bière Blonde Locale 33cl', price: 4.50, categoryId: 'boissons_fraiches', vatId: 'vat_20', barcode: 'BIERE-BLOND-LOC' },
        { name: 'Orangina 25cl', price: 2.70, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'ORANGINA-25' },
        { name: 'Eau Plate 50cl', price: 1.20, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'EAU-PLATE-50' },
        { name: 'Jus de Tomate 25cl', price: 3.00, categoryId: 'boissons_fraiches', vatId: 'vat_10', barcode: 'JUS-TOMATE' },
        // Boissons Chaudes (8)
